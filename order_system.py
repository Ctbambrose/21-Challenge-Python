def place_order(menu):
    ...
    while True:
        ...
        another = input("\nWould you like to order another item?(type 'n' or 'N' to quit) ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if selection in menu_items:
            ...
            quantity=input(f"What is the quantity of {item_name}?")
        ...
        # TODO: tell the customer that their input isn't valid
            ...
            print (f"'{selection}' is not a valid menu item number.")
